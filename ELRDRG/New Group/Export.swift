...
class Export: NSObject {
    func createTemplate()
    {
    let html = "<b>Welcome <i>World!</i></b> <p><h1><font color='red'>This  is PDF file In swift 5.0</font></h1></p>"
...
if createMissionInfo == false
{
    ...
    func generateDocu(mission : Mission) -> String
    {
        ...
        for entry in entries {
           ...
           var img_html = ""
            for attachement in entry.attachments?.allObjects as! [Attachment]
            {
                if(attachement.type == DocumentationType.Photo.rawValue)
                {
                    let image = handler.getImage(pictureName: attachement.uniqueName!)
    ...
    {
        var fahrzeuge = ""
        for unit in section.units?.allObjects as! [Unit] {
        ...
        <tr>
        <td style="width: 50%;" align="center" >
        <a class="fas fa-ambulance" style="font-size: 20px; margin-top: 5px;"></a>
        <a class="fas fa-helicopter" style="font-size: 20px; margin-top: 5px;"></a>
        
        </td>
        <td style="width: 50%;" align="center">
        <a class="fas fa-id-badge" style="font-size: 20px; margin-top: 5px;"></a>
    ...
    func generateVictim(victim : Victim) -> String
    {
        ...
        if(victim.birthdate != nil)
        {
            sDate = formatter.string(from: victim.birthdate!)
        }
